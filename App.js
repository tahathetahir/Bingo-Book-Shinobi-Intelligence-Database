...
function Input4({qqWindow,setqqWindow,setQdata,qdata,setInput4})
{
    ...
    <>        
        ...
        <button onClick = {() => setInput4(false)} className="absolute top-4 left-4 px-8 py-4 bg-red-600 text-white font-semibold rounded-xl transition-all duration-300 hover:bg-white hover:text-red-600 border border-red-600 max-w-2xl ">Back</button>
            <button className ="absolute top-4 right-4 px-8 py-4 bg-red-600 text-white font-semibold rounded-xl transition-all duration-300 hover:bg-white hover:text-red-600 border border-red-600 max-w-2xl "
             onClick = {async () => {await bloodlinePurity(setQdata); setqqWindow(true)}}>
                Begin Purity Analysis
            </button>
...
function Input5({qqWindow,setqqWindow,setQdata,qdata,setInput5})
{
    ...
    <>        
        ...
        <button onClick = {() => setInput5(false)} className="absolute top-4 left-4 px-8 py-4 bg-red-600 text-white font-semibold rounded-xl transition-all duration-300 hover:bg-white hover:text-red-600 border border-red-600 max-w-2xl ">Back</button>
            ...
            placeholder='Enter Ninja ID'
            type = "text"/>
            <input value = {iv1} onChange = {(e) => setIv(e.target.value)}className="w-full px-5 py-4 rounded-2xl bg-black/40 text-white  border border-white/20 outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-500/40 transition-all duration-300"
...
function Input6({qqWindow,setqqWindow,setQdata,qdata,setInput5})
{
    return(
    <>        
        <div className = "fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop">
        ...
        <button onClick = {() => setInput5(false)} className="absolute top-4 left-4 px-8 py-4 bg-red-600 text-white font-semibold rounded-xl transition-all duration-300 hover:bg-white hover:text-red-600 border border-red-600 max-w-2xl ">Back</button>
            <button className ="absolute top-4 right-4 px-8 py-4 bg-red-600 text-white font-semibold rounded-xl transition-all duration-300 hover:bg-white hover:text-red-600 border border-red-600 max-w-2xl "
             onClick = {async () => {await squadFinance(setQdata,iv,iv1); setqqWindow(true)}}>
...
function FeatureCards({qqWindow,setqqWindow,setQdata,qdata}){
    ...
    return(
        <div className = "grid grid-cols-2 gap-6 p-10">
            <div >
             <button onClick = {() => {setInput(true);}} className="bg-black/40 rounded-3xl overflow-hidden shadow-lg shadow-black/30 border border-white/30 transform transition-all duration-300 hover:scale-105 hover:-translate-y-2 hover:shadow-orange-500/30 max-w-2xl mx-auto px-4 py-3 mx-6 flex items-center justify-between">
            ...
            <div>
             <button onClick = {() => {setInput1(true)}} className="bg-black/40 rounded-3xl overflow-hidden shadow-lg shadow-black/30 border border-white/30 transform transition-all duration-300 hover:scale-105 hover:-translate-y-2 hover:shadow-orange-500/30 max-w-2xl mx-auto px-4 py-3 mx-6 flex items-center justify-between">
            ...
            <div>
             <button onClick = {() => {setInput2(true)}} className="bg-black/40 rounded-3xl overflow-hidden shadow-lg shadow-black/30 border border-white/30 transform transition-all duration-300 hover:scale-105 hover:-translate-y-2 hover:shadow-orange-500/30 max-w-2xl mx-auto px-4 py-3 mx-6 flex items-center justify-between">
            ...
            <div>
             <button onClick = {() => {setInput3(true)}} className="bg-black/40 rounded-3xl overflow-hidden shadow-lg shadow-black/30 border border-white/30 transform transition-all duration-300 hover:scale-105 hover:-translate-y-2 hover:shadow-orange-500/30 max-w-2xl mx-auto px-4 py-3 mx-6 flex items-center justify-between">
            ...
            <div>
             <button onClick = {() => {setInput4(true)}} className="bg-black/40 rounded-3xl overflow-hidden shadow-lg shadow-black/30 border border-white/30 transform transition-all duration-300 hover:scale-105 hover:-translate-y-2 hover:shadow-orange-500/30 max-w-2xl mx-auto px-4 py-3 mx-6 flex items-center justify-between">
            ...
            <div>
             <button onClick = {() => {setInput5(true)}} className="bg-black/40 rounded-3xl overflow-hidden shadow-lg shadow-black/30 border border-white/30 transform transition-all duration-300 hover:scale-105 hover:-translate-y-2 hover:shadow-orange-500/30 max-w-2xl mx-auto px-4 py-3 mx-6 flex items-center justify-between">
            ...
            <div>
             <button onClick = {() => {setInput6(true)}} className="bg-black/40 rounded-3xl overflow-hidden shadow-lg shadow-black/30 border border-white/30 transform transition-all duration-300 hover:scale-105 hover:-translate-y-2 hover:shadow-orange-500/30 max-w-2xl mx-auto px-4 py-3 mx-6 flex items-center justify-between">
            ...
            <div>
             <button onClick={async () => { await villageResourceWar(setQdata); setqqWindow(true); }} className="bg-black/40 rounded-3xl overflow-hidden shadow-lg shadow-black/30 border border-white/30 transform transition-all duration-300 hover:scale-105 hover:-translate-y-2 hover:shadow-orange-500/30 max-w-2xl mx-auto px-4 py-3 mx-6 flex items-center justify-between">
                <div><h3 className="text-2xl md:text-4xl font-semibold tracking-wide text-white mb-4">Resource War Sim</h3></div>
                <img src={village} className="w-60 h-16 object-cover rounded-xl"/>
            </button> 
            </div>

            <div>
             <button onClick={async () => { await chuninCorruption(setQdata); setqqWindow(true); }} className="bg-black/40 rounded-3xl overflow-hidden shadow-lg shadow-black/30 border border-white/30 transform transition-all duration-300 hover:scale-105 hover:-translate-y-2 hover:shadow-orange-500/30 max-w-2xl mx-auto px-4 py-3 mx-6 flex items-center justify-between">
                <div><h3 className="text-2xl md:text-4xl font-semibold tracking-wide text-white mb-4">Corruption Detector</h3></div>
                <img src={traitor} className="w-60 h-16 object-cover rounded-xl"/>
            </button> 
            </div>

	    <div>
  	     <button onClick={async () => { await mentorPupilCreep(setQdata); setqqWindow(true); }} className="bg-black/40 rounded-3xl overflow-hidden shadow-lg shadow-black/30 border border-white/30 transform transition-all duration-300 hover:scale-105 hover:-translate-y-2 hover:shadow-orange-500/30 max-w-2xl mx-auto px-4 py-3 mx-6 flex items-center justify-between">
	    ...
	    <div>
             <button onClick={() => {setInput7(true)}} className="bg-black/40 rounded-3xl overflow-hidden shadow-lg shadow-black/30 border border-white/30 transform transition-all duration-300 hover:scale-105 hover:-translate-y-2 hover:shadow-orange-500/30 max-w-2xl mx-auto px-4 py-3 mx-6 flex items-center justify-between">
          	...
          	<div>
          	    <button onClick={async () => { await globalPowerIndex(setQdata); setqqWindow(true); }} className="bg-black/40 rounded-3xl overflow-hidden shadow-lg shadow-black/30 border border-white/30 transform transition-all duration-300 hover:scale-105 hover:-translate-y-2 hover:shadow-orange-500/30 max-w-2xl mx-auto px-4 py-3 mx-6 flex items-center justify-between">
          	...
          	<div>
          	    <button onClick={async () => { await squadCarryAudit(setQdata); setqqWindow(true); }} className="bg-black/40 rounded-3xl overflow-hidden shadow-lg shadow-black/30 border border-white/30 transform transition-all duration-300 hover:scale-105 hover:-translate-y-2 hover:shadow-orange-500/30 max-w-2xl mx-auto px-4 py-3 mx-6 flex items-center justify-between">
          		<div><h3 className="text-2xl md:text-4xl font-semibold tracking-wide text-white mb-4">Squad Carry Audit</h3></div>
          		<img src={sanin} className="w-60 h-16 object-cover rounded-xl"/>
          	    </button> 
          	</div>

          	<div>
          	    <button onClick={async () => { await historicalRivalry(setQdata); setqqWindow(true); }} className="bg-black/40 rounded-3xl overflow-hidden shadow-lg shadow-black/30 border border-white/30 transform transition-all duration-300 hover:scale-105 hover:-translate-y-2 hover:shadow-orange-500/30 max-w-2xl mx-auto px-4 py-3 mx-6 flex items-center justify-between">
          	...
          	<div>
          	    <button onClick={async () => { await blackMarketAudit(setQdata); setqqWindow(true); }} className="bg-black/40 rounded-3xl overflow-hidden shadow-lg shadow-black/30 border border-white/30 transform transition-all duration-300 hover:scale-105 hover:-translate-y-2 hover:shadow-orange-500/30 max-w-2xl mx-auto px-4 py-3 mx-6 flex items-center justify-between">
