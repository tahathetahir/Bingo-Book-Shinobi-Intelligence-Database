...
predicting future military capabilities of one’s own nation.
In a nutshell, a well-structured ninja database is the bread and butter of today’s ninja world.
...
chunin. This project aims to maintain shinobi database of :
1. Novice shinobis enrolled in academy of different nations
2. Shinobis that passed the Genin exams
3. Shinobis assigned to different rank missions
4. Shinobis Shinobis participating in Chunin exams.
Not all shinobis conform to the structures of the ninja world and its ideologies. Not all are
...
for the good of all.
5. This project also aims to maintain a bingo book, keeping intel on any shinobis that
have gone rogue to do the aforementioned deed.
...
this project also:
6. Maintains track of village’s military arsenals and ninjutsu resources.
